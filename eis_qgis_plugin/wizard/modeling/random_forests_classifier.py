...
FORM_CLASS: QWidget = load_ui("model/wizard_model_random_forests.ui")


class EISWizardRandomForestsClassifier(EISModel, FORM_CLASS):
    """
    Class for random forests classifier.
    """
    ...
    def read_model_parameters(self):
        n_estimators = self.n_estimators_cb.currentText()
