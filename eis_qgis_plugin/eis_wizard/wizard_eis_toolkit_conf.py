...
class EISWizardToolkitConfiguration(QWidget, FORM_CLASS):
    ...
    def __init__(self, parent=None) -> None:
        ...
        self.venv_conf_button_box: QDialogButtonBox
        ...
        # Initialize
        self.create_venv_btn = self.venv_conf_button_box.addButton("Create new venv", QDialogButtonBox.ActionRole)
        self.create_venv_btn.setIcon(QIcon(os.path.join(PLUGIN_PATH, "resources/icons/python_add_icon.png")))
        self.install_btn = self.venv_conf_button_box.addButton(
            "Install and upgrade EIS Toolkit", QDialogButtonBox.ActionRole
        )
    ...
    def _on_environment_type_changed(self, docker_selected: bool):
        ...
        if docker_selected:
            ...
            self.venv_conf_button_box.show()
