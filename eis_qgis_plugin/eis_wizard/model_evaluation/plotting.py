...
from eis_qgis_plugin.eis_wizard.eda.plots.pairplot import EISWizardPairplot
from eis_qgis_plugin.eis_wizard.eda.plots.parallel_coordinates import EISWizardParallelCoordinatesPlot
