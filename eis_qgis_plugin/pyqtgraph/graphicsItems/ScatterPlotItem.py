...
class SymbolAtlas(object):
    ...
    def _createPixmap(self):
        ...
        if self._data.size == 0:
            ...
            img = fn.ndarray_to_qimage(
                self._data, QtGui.QImage.Format.Format_ARGB32_Premultiplied
            )
...
class ScatterPlotItem(GraphicsObject):
    ...
    **Signals:**
    ...
    def __init__(self, *args, **kargs):
        ...
        self._pixmapFragments = Qt.internals.PrimitiveArray(
            QtGui.QPainter.PixmapFragment, 10
        )
        self.opts = {
            "pxMode": True,
    ...
    def paint(self, p, *args):
        ...
        if self.opts["pxMode"] is True:
            ...
            if self.opts["useCache"] and self._exportOpts is False:
                ...
                frags[:, 0:2] = xy
                frags[:, 2:6] = np.frombuffer(sr, dtype=int).reshape(
                    (-1, 4)
                )  # sx, sy, sw, sh
                frags[:, 6:10] = [
                    1.0,
