...
class ImageExporter(Exporter):
    ...
    def widthChanged(self):
        ...
        self.params.param("height").setValue(
            int(self.params["width"] * ar), blockSignal=self.heightChanged
        )
    ...
    def heightChanged(self):
        ...
        self.params.param("width").setValue(
            int(self.params["height"] * ar), blockSignal=self.widthChanged
        )
    ...
    def export(self, fileName=None, toBytes=False, copy=False):
        ...
        try:
            ...
            painter.setRenderHint(
                QtGui.QPainter.RenderHint.Antialiasing, self.params["antialias"]
            )
