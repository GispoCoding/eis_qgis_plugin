...
p4 = win.addPlot(
    ...
    y=y,
    name="Plot4",
    title="Plot4: X -> Plot3 (deferred), Y -> Plot1",
    row=2,
    col=1,
)
p4.setXLink(
    "Plot3"
)  ## Plot3 has not been created yet, but this should still work anyway.
p4.setYLink(p1)
p3 = win.addPlot(
    x=x, y=y, name="Plot3", title="Plot3: X linked with Plot1", row=2, col=0
)
p3.setXLink(p1)
