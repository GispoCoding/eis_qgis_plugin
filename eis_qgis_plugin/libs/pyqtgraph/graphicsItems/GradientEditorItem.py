    ...
    def setOrientation(self, orientation):
        ...
        **Arguments:**
        ...
        if ort == "top":
            ...
            raise Exception(
                "%s is not a valid orientation. Options are 'left', 'right', 'top', and 'bottom'"
                % str(ort)
            )
    ...
    def addTick(self, x, color=None, movable=True, finish=True):
        ...
        **Arguments:**
        ...
        tick = Tick(
            ...
            self.tickSize,
            pen=self.tickPen,
            removeAllowed=self.allowRemove,
        )
        self.ticks[tick] = x
    ...
    **Signals:**
    ...
    def __init__(self, *args, **kargs):
        ...
        **Arguments:**
        ...
        self.rectSize = 15
        self.gradRect = QtWidgets.QGraphicsRectItem(
            QtCore.QRectF(0, self.rectSize, 100, self.rectSize)
        )
        self.backgroundRect = QtWidgets.QGraphicsRectItem(
            QtCore.QRectF(0, -self.rectSize, 100, self.rectSize)
        )
...
class TickMenu(QtWidgets.QMenu):
    def __init__(self, tick, sliderItem):
        ...
        self.removeAct = self.addAction(
            translate("GradientEditorItem", "Remove Tick"),
            lambda: self.sliderItem().removeTick(tick),
        )
        ...
        l.addWidget(
            QtWidgets.QLabel(f"{translate('GradiantEditorItem', 'Position')}:"), 0, 0
        )
        ...
        colorAct = self.addAction(
            translate("Context Menu", "Set Color"),
