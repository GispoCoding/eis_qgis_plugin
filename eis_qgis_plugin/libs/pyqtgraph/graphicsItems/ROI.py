...
class ROI(GraphicsObject):
    ...
    **Signals**
    ...
    def setAngle(
        self, angle, center=None, centerLocal=None, snap=False, update=True, finish=True
    ):
        """
    ...
    def scale(
        self, s, center=None, centerLocal=None, snap=False, update=True, finish=True
    ):
        """
    ...
    def rotate(self, angle, center=None, snap=False, update=True, finish=True):
        ...
        **Arguments**
        ...
        """
        self.setAngle(
            self.angle() + angle, center=center, snap=snap, update=update, finish=finish
        )
    ...
    def addScaleRotateHandle(self, pos, center, item=None, name=None, index=None):
        ...
        **Arguments**
        ...
        return self.addHandle(
            {"name": name, "type": "sr", "center": center, "pos": pos, "item": item},
            index=index,
        )
    ...
    def getSnapPosition(self, pos, snap=None):
        ...
        return Point(
            round(pos[0] / snap[0]) * snap[0], round(pos[1] / snap[1]) * snap[1]
        )
    ...
    def getArrayRegion(self, data, img, axes=(0, 1), returnMappedCoords=False, **kwds):
        ...
        **Arguments**
        ...
        _shape, _vectors, _origin = self.getAffineSliceParams(
            data, img, axes, fromBoundingRect=fromBR
        )
    ...
    def setDeletable(self, b):
        ...
        if b:
            self.setAcceptedMouseButtons(
                self.acceptedMouseButtons() | QtCore.Qt.MouseButton.RightButton
            )
        else:
            self.setAcceptedMouseButtons(
                self.acceptedMouseButtons() & ~QtCore.Qt.MouseButton.RightButton
...
class EllipseROI(ROI):
    ...
    **Arguments**
    ...
    def _addHandles(self):
        ...
        self.addScaleHandle(
            [0.5 * 2.0**-0.5 + 0.5, 0.5 * 2.0**-0.5 + 0.5], [0.5, 0.5]
        )
...
class RulerROI(LineSegmentROI):
    def paint(self, p, *args):
        ...
        p.drawText(
            QtCore.QRectF(pos.x() - 50, pos.y() - 50, 100, 100),
