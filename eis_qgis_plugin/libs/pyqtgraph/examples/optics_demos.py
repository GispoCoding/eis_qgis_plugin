...
## Scan lenses
l3 = Lens(
    r1=23.0, r2=0, d=5.8, pos=(scanx + 50, scany), glass="Corning7980"
)  ## 50mm  UVFS  (LA4148)
l4 = Lens(
    r1=0, r2=69.0, d=3.2, pos=(scanx + 250, scany), glass="Corning7980"
)  ## 150mm UVFS  (LA4874)
...
## Scan lenses
l3a = Lens(
    r1=46, r2=0, d=3.8, pos=(scanx + 50, 3 * scany), glass="Corning7980"
)  ## 100mm UVFS  (LA4380)
l4a = Lens(
    r1=0, r2=46, d=3.8, pos=(scanx + 250, 3 * scany), glass="Corning7980"
)  ## 100mm UVFS  (LA4380)

## Objective
obja = Lens(
    r1=15, r2=15, d=10, dia=8, pos=(scanx + 400, 3 * scany), glass="Corning7980"
)
