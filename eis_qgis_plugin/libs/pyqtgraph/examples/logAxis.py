...
w.resize(800, 800)
w.setWindowTitle(
    "pyqtgraph example: Log Axis, or How to Recognise Different Types of Curves from Quite a Long Way Away"
)
...
for p in (p0, p1, p2, p3):  # draw identical numerical data in all four plots
    ...
    p.showAxes(
        True, size=(40, None)
    )  # show a full frame, and reserve identical room for y labels
