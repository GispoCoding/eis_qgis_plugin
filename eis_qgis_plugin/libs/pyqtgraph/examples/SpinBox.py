...
spins = [
    ...
    (
        ...
        pg.SpinBox(
            value=1.0, suffix="PSI", siPrefix=True, dec=True, step=0.1, minStep=0.1
        ),
    ),
    (
        "Float with SI-prefixed units,<br>dec step=0.5, minStep=0.01",
        pg.SpinBox(
            value=1.0, suffix="V", siPrefix=True, dec=True, step=0.5, minStep=0.01
        ),
    ),
    (
        "Float with SI-prefixed units,<br>dec step=1.0, minStep=0.001",
        pg.SpinBox(
            value=1.0, suffix="V", siPrefix=True, dec=True, step=1.0, minStep=0.001
        ),
    ),
    ...
    (
        ...
        pg.SpinBox(
            value=10, bounds=[10, 20], int=True, minStep=1, step=1, wrapping=True
        ),
    ),
]
...
changedLabel = (
    QtWidgets.QLabel()
)  ## updated only when editing is finished or mouse wheel has stopped for 0.3sec
