...
class SpinBox(QtWidgets.QAbstractSpinBox):
    ...
    **Signals:**
    ...
    sigValueChanging = QtCore.Signal(
        object, object
    )  # (self, value)  sent immediately; no delay.
    ...
    def __init__(self, parent=None, value=0.0, **kwargs):
        ...
        **Arguments:**
        ...
        self.val = decimal.Decimal(
            str(value)
        )  ## Value is precise decimal. Ordinary math not allowed.
        self.updateText()
    ...
    def formatText(self, prev=None):
        ...
        parts["suffixGap"] = (
            "" if (parts["suffix"] == "" and parts["siPrefix"] == "") else " "
        )
    ...
    def interpret(self):
        ...
        try:
            val, siprefix, suffix = fn.siParse(
                strn, self.opts["regex"], suffix=self.opts["suffix"]
            )
        except Exception:
            return False
