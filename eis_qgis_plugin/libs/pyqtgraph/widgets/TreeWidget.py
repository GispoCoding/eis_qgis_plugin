...
class TreeWidget(QtWidgets.QTreeWidget):
    ...
    def __init__(self, parent=None):
        ...
        # to children.
        self._invRootItem = InvisibleRootItem(
            QtWidgets.QTreeWidget.invisibleRootItem(self)
        )
    ...
    def recoverMove(self, item):
        ...
        item.setExpanded(
            False
        )  ## Items do not re-expand correctly unless they are collapsed first.
